...
IntNMI:
	...
	JMP PRG030_SUB_9F40	 ; Jump to PRG030_SUB_9F40, which resets Raster and ends up at PRG031_F499

PRG031_F499: ; still in NMI!
...
; this table seems to implement the logic that avoids up+down and left+right
; Basically, only one of bits 0/1 can be set, same for 2/3
...
PRG031_FEC3:
	...
	BNE PRG031_FEC3	 ; If not, do it again
        ...
        ; this logic applies the rules to prevent L+R, U+D using table from above
	ORA <Temp_Var2	 ; 
	PHA		 ; Push A
	AND #$0f	 ; A &= $0F
	TAX		 ; A -> X
...
Read_Joypad_Loop:
	...
	LSR A            ; bit 0 --> carry
	ROL <Temp_Var1   ; carry --> bit 0
	LSR A            ; bit 0 --> carry
	ROL <Temp_Var2   ; carry --> bit 0
	DEX
