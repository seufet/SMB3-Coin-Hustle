...
PRG030_8EE7:
	...
	; coin hustle...
	; banks: A=8, C=0
	; can JSR here to a function that calls Player_DoGamePlay, then bank swaps for PRG24, calls function, bank swaps back, and returns...
...
PRG030_SUB_9F40:
	...
	LDA Update_Request
	JMP PRG031_F499 ; ends up at PRG031_F499
...
; We add our Coin Hustle function here!
CoinHustleStub:
	; do the ordinary gameplay
