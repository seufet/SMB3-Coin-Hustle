...
PRG001_AF02:
 ...
 PRG001_AF0B:
	...
	CMP #$10	
	BGE PRG001_AF20	 ; If Koopaling's X - 120 >= $10, jump to PRG001_AF20
...
PRG001_B8D3:
	...
	LDA <Objects_Var5,X	
	CMP #$01	 
	BEQ PRG001_B8E5	 ; If internal state = 1 (Bowser active, but not dead), jump to PRG001_B8E5 (RTS)
...
PRG001_B9BF:
	LDA Objects_Timer,X 
	CMP #$01 
	BEQ PRG001_B9F3	 ; If timer expired, jump to PRG001_B9F3 -- do a little hop
...
PRG001_BA4B:
	...
	AND #$1f	
	ADC #$67	
	STA Objects_Timer3,X	 ; Timer 3 = Random $67 to $86 (after landing, waits 103-134f)
...
PRG001_BACD:
	...
	AND #$7f
	ORA #$80
	STA Objects_Timer3,X	 ; Timer 3 = $7F to $FF -- this sets how long bowser waits before big jump
