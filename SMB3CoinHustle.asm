Level_BlkBump	.inesprg 16  ; 16x 16KB PRG code (32 banks of 8KB)
...
; NOTE!! This object var is OBJECT SLOT 0 - 4 ONLY!
	...
	CoinHustle_TopWalkSpeed:			.ds 1	; $E3 - hustle-dependent fastest walking/flying speed, Coin Hustle - previously unused 
	...
	Scroll_Temp:			.ds 1	; $e9 - temp value for scrolling (Southbird had marked this unused in gameplay, but it IS used...)
	CoinHustle_TopRunSpeed:			.ds 1	; $EA - hustle-dependent fastest running speed - Coin Hustle - previously unused
...
; --------- BOT OF MAP
	...
	Inventory_Coins:	.ds 1	; Mario's coins $7da2
	...
	Inventory_Coins2:	.ds 1	; Luigi's coins $7dc5
...
; XXX coin hustle constants for top speeds...
...
PLAYER_MAXSPEED		= $40	; Player's maximum speed - enforced in PRG8
